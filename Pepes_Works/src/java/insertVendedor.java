 ...
 * @author Jeremy
 */
@WebServlet(urlPatterns = {"/insertVendedor"})
public class insertVendedor extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        //response.setContentType("ingresar_vendedor/xhtml;charset=UTF-8");
        String rut = request.getParameter("Rut");
        String clave1 = request.getParameter("Contrasenna1");
